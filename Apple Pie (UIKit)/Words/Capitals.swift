...
extension GuessingCollection {
    static let capitals = GuessingCollection(
        ...
        list: [
            ...
            WordToGuess(word: "Габороне", info: "Столица Ботсваны", hint: "🇧🇼"),
            ...
            WordToGuess(word: "Валлетта", info: "Столица Мальты", hint: "🇲🇹"),
            ...
            WordToGuess(word: "Варшава", info: "Столица Польши", hint: "🇵🇱"),
            ...
            WordToGuess(word: "Сеул", info: "Столица Республики Корея (неофициальное название Южная Корея)", hint: "🇰🇷"),
